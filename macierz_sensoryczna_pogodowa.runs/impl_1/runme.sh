...
HD_PWD='E:/Studia/LUC/Projekt/macierz_sensoryczna_pogodowa/macierz_sensoryczna_pogodowa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log weather_matrix_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source weather_matrix_top.tcl -notrace
