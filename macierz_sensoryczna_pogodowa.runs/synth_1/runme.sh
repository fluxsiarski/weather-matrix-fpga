...
HD_PWD='E:/Studia/LUC/Projekt/macierz_sensoryczna_pogodowa/macierz_sensoryczna_pogodowa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weather_matrix_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weather_matrix_top.tcl
